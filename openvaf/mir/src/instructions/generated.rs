...
pub(super) const OPCODE_CONSTRAINTS: [OpcodeConstraints; 71usize + 1] = [
...
pub(super) const OPCODE_NAMES: [&str; 71usize + 1] = [
    "",
    "inot",
    "bnot",
    "fneg",
...
pub(super) const OPCODE_FORMAT: [InstructionFormat; 71usize + 1] = [
