...
impl SyntaxKind {
    pub fn is_keyword(self) -> bool {
        match self {
            ANALOG_KW | BEGIN_KW | BRANCH_KW | BREAK_KW | CASE_KW | CONTINUE_KW | DEFAULT_KW
            | DISABLE_KW | DISCIPLINE_KW | ELSE_KW | END_KW | ENDCASE_KW | ENDDISCIPLINE_KW
            | ENDFUNCTION_KW | ENDMODULE_KW | ENDNATURE_KW | EXCLUDE_KW | FOR_KW | FROM_KW
            ...
            | FINAL_STEP_KW | FINAL_KW | ALIASPARAM_KW | EVENT_KW | OR_KW => true,
            _ => false,
        }
    }
